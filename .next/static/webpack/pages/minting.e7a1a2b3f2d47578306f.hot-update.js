...
var MintingPage = function MintingPage() {
  ...
  var claimNFTs = function claimNFTs(mintAmount, whitelist) {
    ...
    if (whitelist == true) totalCostWei = 0;
