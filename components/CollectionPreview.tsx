...
export default function CollectionPreview() {
  return (
    ...
    <section
      className="bg-underwater-mobile -ml-1 sm:bg-underwater bg-cover bg-no-repeat pt-16 md:pt-5 pb-[40px] mt-[-2px]"
    ...
    >
      <Container className="flex space-x-8">
        ...
        <div className="w-full pr-8">
          <p className="mt-20 text-white md:mt-7">
            A collection of digital collectibles living eternally on the
            Ethereum blockchain.{' '}
          </p>
          <p className="text-white mt-7">
            Yubba World is populated by 2,500 uniquely created Yubbas. The
            powers of the Yubba’s must be trained and honed. Each Yubba have
            been formed with their own characteristics, attributes and
            expressions, to be your companion that can truly be unique and
            yours.{' '}
          </p>
      ...
      <div className="relative block lg:hidden mx-auto mt-12 max-w-[375px] h-[520px]">
        <div className="absolute inline-block left-[0px] top-[0px]">
          <Image
            src="/collection-preview/yubba-blupatch.png"
            layout="fixed"
            width={140}
            height={152}
            alt="Yubba Big With Horns"
          />
        </div>
        <div className="absolute inline-block left-[36px] top-[160px] z-10">
          <Image
            src="/collection-preview/yubba-bigwithhorns.png"
            layout="fixed"
            width={302}
            height={330}
            alt="Yubba Big With Horns"
        ...
        <div className="absolute inline-block left-[200px] top-[40px]">
          <Image
            src="/collection-preview/yubba-blue.png"
            layout="fixed"
            width={176}
            height={190}
            alt="Yubba Big With Horns"
      ...
      <div className="relative hidden lg:block mx-auto mt-12 w-[1024px] h-[520px]">
        <div className="absolute inline-block left-[20px] top-[30px]">
          <Image
            src="/collection-preview/yubba-violet.png"
            layout="fixed"
            width={111}
            height={121}
            alt="Yubba Big With Horns"
